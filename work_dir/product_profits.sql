...
-- WHERE (od.totalQuantityOrdered / p.quantityInStock) >0.7 AND (od.totalQuantityOrdered / p.quantityInStock) <0.82
-- WHERE (od.profit * 100 / totalTotalProfit.totalTotalProfit) > 1 AND od.profit * 100 / totalTotalProfit.totalTotalProfit < 1.5
ORDER BY
	profit_pcnt DESC;
